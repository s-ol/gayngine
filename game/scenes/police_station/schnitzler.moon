...
clickable_dialogue Dialogue =>
	...
	if SCENE.state.police == nil
		...
		@schnitzler\say "as far as im informed you are no undercover detective, are you?" 
		...
		elseif res == "argue"
			...
			@schnitzler\say "maybe you should think twice where to spend your time though"
			@schnitzler\say "im not the one who took the picture"
			@schnitzler\say "so at least one other person has seen you."
		elseif res == "beg"
