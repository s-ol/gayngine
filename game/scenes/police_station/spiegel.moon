...
clickable_dialogue Dialogue =>
	if SCENE.state.police < 4
		...
		if SCENE.state.spiegelquestionwork == nil and SCENE.state.spiegelquestionyou == nil
			res = @player\choice { you: "You are leo spiegel, right?", _label: "about you" },
			...
			if res == "you"
				...
				@splayer\say ".%%%%%%%%.%%%%%%%%."
				SCENE.state.spiegelquestionyou = 1
			if res == "work"
				...
				@splayer\say ".%%%%%%%%.%%%%%%%%."
				SCENE.state.spiegelquestionwork = 1
			if res == "nothing"
				@spiegel\say "Oh, that happens from time to time"
		elseif SCENE.state.spiegelquestionwork == 1 and SCENE.state.spiegelquestionyou == nil
			res = @player\choice { you: "You are leo spiegel, right?", _label: "about you" },
													 { nothing: "Oh, i think i took the wrong turn somewhere", _label: "nothing"}
			if res == "you"
				@player\say "I heard a lot about you"
			...
			if res == "nothing"
				@spiegel\say "Oh, that happens from time to time"
		elseif SCENE.state.spiegelquestionwork == nil and SCENE.state.spiegelquestionyou == 1
			res = @player\choice { work: "What is it exactly that you are doing here?", _label: "about your work" },
													 { nothing: "Oh, i think i took the wrong turn somewhere", _label: "nothing"}
			if res == "work"
				@spiegel\say "Oh, i know everything about this archieves"
				@spiegel\say "I sort and find the things that need to be stored"
			...
			if res == "nothing"
				@spiegel\say "Oh, that happens from time to time"
		elseif SCENE.state.spiegelquestionwork == 1 and SCENE.state.spiegelquestionyou == 1
			res = @player\choice { you: "You are leo spiegel, right?", _label: "about you" },
													 { work: "What is it exactly that you are doing here?", _label: "about your work" },
													 { nothing: "Oh, i think i took the wrong turn somewhere", _label: "nothing"}
			if res == "nothing"
